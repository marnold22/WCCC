...
(function() {
    ...
    function drawBurgerMenu(canvas, progress, targetFrame, resizing) {
        ...
        context.scale(resizedFrame.w / 175, resizedFrame.h / 125);
        ...
        //// Rectangle 3 Drawing
        context.save();
        context.translate(87.5, (topYPos + 12.5));
        context.rotate(-topRotation * Math.PI / 180);

        roundedRect(context, -87.5, -12.5, 175, 25, 12.5);
        ...
        //// Rectangle Drawing
        context.save();
        context.translate(87.5, (bottomYPos + 12.5));
        ...
        roundedRect(context, 0, 50, 175, 25, 12.5);
        context.fillStyle = white;
        context.fill();
        context.restore();
