...
//  WCCC
//
//  Created by Tyler Reardon on 4/6/17.
//  Copyright © 2017 Pacific North Dev. All rights reserved.
//
...
(function() {
    ...
    function drawBurgerMenu(canvas, progress, targetFrame, resizing) {
        ...
        context.save();
        var resizedFrame = applyResizingBehavior(resizing, makeRect(0, 0, 125, 125), targetFrame);
        context.translate(resizedFrame.x, resizedFrame.y);
        context.scale(resizedFrame.w / 125, resizedFrame.h / 125);


        //// Color Declarations
        var white = 'rgba(0, 0, 0, 1)';
        ...
        //// Rectangle 3 Drawing
        context.save();
        context.translate(62.5, (topYPos + 12.5));
        context.rotate(-topRotation * Math.PI / 180);

        roundedRect(context, -62.5, -12.5, 125, 25, 12.5);
        ...
        //// Rectangle Drawing
        context.save();
        context.translate(62.5, (bottomYPos + 12.5));
        ...
        roundedRect(context, 0, 50, 125, 25, 12.5);
        context.fillStyle = white;
        context.fill();
        context.restore();
