...
function abcfsl_mbox_tplate_spg_layout( $tplateOptns ){
    ...
    echo  abcfl_html_tag('div','','inside hidden');
       ...
       //-- ADD NEW Record Screen. Display only Add New Layout cbo ------------------------
        ...
        abcfsl_mbox_tplate_staff_spg_layout_optns_pg( $spgCntrW, $spgCntrCls, $spgCntrStyle, $spgACenter);
        abcfsl_mbox_tplate_staff_spg_layout_optns_m( $spgCols, $spgMMarginT );

    echo abcfl_html_tag_end('div');
}

//Content Container Style
function abcfsl_mbox_tplate_staff_spg_layout_optns_pg( $spgCntrW, $spgCntrCls, $spgCntrStyle, $spgACenter){

    abcfl_input_sec_icon_hdr_hlp( ABCFSL_ICONS_URL, 'staff-single-pg.png', abcfsl_txta(240), abcfsl_txta(322), abcfsl_aurl(29) );
...
function abcfsl_mbox_tplate_staff_spg_layout_optns_m( $spgCols, $spgMMarginT ){
